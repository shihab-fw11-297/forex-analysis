...
let result3 = predictNextCandleDirectionSecond(data);
const result4 = predictNextDirectionNews(data);
const result5 = predictNextCandle5(data);
let result6 = predictNextCandle7(data);
let result7 = predictNextCandle8(data);
...
console.log(`Total "up" count: ${upCount}`);
console.log(`Total "down" count: ${downCount}`);
console.log(`Total "flat" count: ${flatCount}`);
